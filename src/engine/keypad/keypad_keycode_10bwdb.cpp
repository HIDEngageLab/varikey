...
namespace engine
{
    namespace keypad
    {
        const code_table_t Keypad10BWDB::number_value = {
        ...
        const code_table_t Keypad10BWDB::telephon_value = {
        ...
        const code_table_t Keypad10BWDB::functional_value = {
        ...
        const code_table_t Keypad10BWDB::multimedia_value = {
            {key_code_t::SINGLE, 0, {HID_KEY_ESCAPE}},
        ...
        const code_table_t Keypad10BWDB::navigation_value = {
            {key_code_t::SINGLE, 0, {HID_KEY_ESCAPE}},
        ...
        const code_table_t Keypad10BWDB::custom_value = {
