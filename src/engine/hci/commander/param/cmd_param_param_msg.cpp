...
extern void cmd_param_param_msg_req(chunk_t const *const _chunk, cmd_param_msg_t *const _msg)
{
    ...
    /* deserialize */
    _msg->identifier = static_cast<param_identifier_t>(_chunk->space[0]);
    _msg->function = static_cast<cmd_param_function_t>(_chunk->space[1]);
