...
#ifndef __IMAGE_ADD_CIRCLE_8_H__
#define __IMAGE_ADD_CIRCLE_8_H__

extern const unsigned char IMAGE_ADD_CIRCLE_8_WIDTH;
extern const unsigned char IMAGE_ADD_CIRCLE_8_HEIGHT;
