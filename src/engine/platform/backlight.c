...
static void perform_step(const int _delay)
{
    ...
    if (left_changed || right_changed)
    {
        ...
        ws2812_put_pixel(backlight.left.curent.rgb.r, backlight.left.curent.rgb.g, backlight.left.curent.rgb.b);
        ws2812_put_pixel(backlight.middle.rgb.r, backlight.middle.rgb.g, backlight.middle.rgb.b);
        ws2812_put_pixel(backlight.right.curent.rgb.r, backlight.right.curent.rgb.g, backlight.right.curent.rgb.b);
    }
}
