...
#ifndef __PLATFORM_KEYPAD_APD5585_VARIKEY_H__
#define __PLATFORM_KEYPAD_APD5585_VARIKEY_H__

namespace platform
{
    namespace hardware
    {
        struct KeypadApd5585Varikey
        {
...
#endif /* __PLATFORM_KEYPAD_APD5585_VARIKEY_H__ */
