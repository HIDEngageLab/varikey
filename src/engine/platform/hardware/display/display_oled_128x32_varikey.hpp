...
#ifndef __PLATFORM_DISPLAY_OLED_128X32_VARIKEY_H__
#define __PLATFORM_DISPLAY_OLED_128X32_VARIKEY_H__

namespace platform
{
    namespace hardware
    {
        struct DisplayOLED128x32Varikey
        {
...
#endif /* __PLATFORM_DISPLAY_OLED_128X32_VARIKEY_H__ */
