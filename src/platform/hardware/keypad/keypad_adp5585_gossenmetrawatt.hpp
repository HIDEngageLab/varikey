...
#ifndef __PLATFORM_KEYPAD_APD5585_GOSSENMETRAWATT_HPP__
#define __PLATFORM_KEYPAD_APD5585_GOSSENMETRAWATT_HPP__
...
namespace platform
{
    namespace hardware
    {
        struct KeypadApd5585Gossenmetrawatt : public KeypadApd5585
        {
...
#endif /* __PLATFORM_KEYPAD_APD5585_GOSSENMETRAWATT_HPP__ */
